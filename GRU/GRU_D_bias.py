    ...
    def call(self, inputs, states, training=None):
        ...
        if self.implementation == 1:
            ...
            if self.use_bias:
                ...
                #exit()
                m_squeeze = tf.squeeze(m, 1) # m = 1 --> is_under
                #x_z = K.bias_add(x_z, self.input_bias_z) + K.bias_add(m, self.input_nan_bias_z)
                #x_r = K.bias_add(x_r, self.input_bias_r) + K.bias_add(m, self.input_nan_bias_r)
                #x_h = K.bias_add(x_h, self.input_bias_h) + K.bias_add(m, self.input_nan_bias_h)
